...
$ pyang ietf-yp-notification@2025-02-19.yang -f tree -p dependencies --tree-line-length=69 --tree-print-structures
$ pyang ietf-yp-observation@2025-02-19.yang -f tree -p dependencies --tree-line-length=69 --tree-print-structures
```
